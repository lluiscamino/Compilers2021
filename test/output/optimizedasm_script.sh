...
as optimizedasm/quicksort.asm -o optimizedasm/quicksort.asm.o
ld optimizedasm/quicksort.asm.o -o optimizedasm/quicksort.asm-exec -macosx_version_min 11.0  -L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib -lSystem
./optimizedasm/quicksort.asm-exec > outputs/quicksort.asm.txt
diff -y -q -w outputs/quicksort.asm.txt expectedoutputs/quicksort.asm.txt
rm optimizedasm/quicksort.asm.o
rm optimizedasm/quicksort.asm-exec
...
as optimizedasm/printarray.asm -o optimizedasm/printarray.asm.o
ld optimizedasm/printarray.asm.o -o optimizedasm/printarray.asm-exec -macosx_version_min 11.0  -L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib -lSystem
./optimizedasm/printarray.asm-exec > outputs/printarray.asm.txt
diff -y -q -w outputs/printarray.asm.txt expectedoutputs/printarray.asm.txt
rm optimizedasm/printarray.asm.o
rm optimizedasm/printarray.asm-exec
...
as optimizedasm/multidimensionalarrayinstance.asm -o optimizedasm/multidimensionalarrayinstance.asm.o
ld optimizedasm/multidimensionalarrayinstance.asm.o -o optimizedasm/multidimensionalarrayinstance.asm-exec -macosx_version_min 11.0  -L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib -lSystem
./optimizedasm/multidimensionalarrayinstance.asm-exec > outputs/multidimensionalarrayinstance.asm.txt
diff -y -q -w outputs/multidimensionalarrayinstance.asm.txt expectedoutputs/multidimensionalarrayinstance.asm.txt
rm optimizedasm/multidimensionalarrayinstance.asm.o
rm optimizedasm/multidimensionalarrayinstance.asm-exec
