...
public final class ArithmeticAdd extends Expression {
    ...
    public void toDot(StringBuilder buffer) {
        DotNode dotNode = new DotNode(buffer, "ARITH_ADD", "", "filled", "#00a2ff");
        
        dotNode.addEdge((StringBuilder buffer1) -> {
            DotNode dotNode1 = new DotNode(buffer1, "arithAdd", "plaintext", "", "");
        }, "ident");
