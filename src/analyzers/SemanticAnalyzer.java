...
public final class SemanticAnalyzer {
    ...
    public void optimizeTACInstructionList(int maxCycles) {
        ...
        do {
            ...
            tacInstructionList = new ZeroIndexesOptimizer(new NeedlessGotosOptimizer(new InaccessibleCodeOptimizer(new UnusedTagsOptimizer(new ConstantIfsOptimizer(new ArithmeticOperationsOptimizer(new ConstantOperationsOptimizer(new DifferedAssignmentsOptimizer(new AdjacentBranchesOptimizer(tacInstructionList).optimize()).optimize()).optimize()).optimize()).optimize(), subprogramsTable).optimize()).optimize()).optimize()).optimize();
